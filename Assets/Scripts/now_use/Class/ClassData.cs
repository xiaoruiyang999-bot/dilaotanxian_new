...
/// 七维占位数值（移速 5/攻击 5/暴击 0.2/暴伤 1.5/R 0.3/L 1.0）待设计 D 定稿后填。
/// </summary>
...
public class ClassData : ScriptableObject
{
    ...
    [Header("七维（v0.7.0 六维 + 移速收编；占位默认值同 PlayerStats 兜底常量）")]
    [SerializeField] private float moveSpeed = 5f;              // 基础移速（任务书 §一 暂定 5.0）
